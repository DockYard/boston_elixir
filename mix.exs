defmodule BostonElixir.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:live_view_native_swiftui, github: "liveview-native/liveview-client-swiftui", tag: "0.3.0-alpha.3"},
